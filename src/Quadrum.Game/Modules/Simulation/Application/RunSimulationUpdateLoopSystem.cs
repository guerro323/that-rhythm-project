...
public class RunSimulationUpdateLoopSystem : AppSystem
{
    ...
    private SimulationUpdateLoop simulationUpdateLoop;

    public RunSimulationUpdateLoopSystem(Scope scope) : base(scope)
    {
    ...
    {
        simulationUpdateLoop = new SimulationUpdateLoop(world);
        scope.Context.Register<ISimulationUpdateLoopSubscriber>(simulationUpdateLoop);
